...
class UsuarioControllerTest {
    ...
    companion object {
        private const val RECURSO = "/v1/usuarios"
    ...
    @Test
    fun `deve retornar codigo 400 quando chamar usuarios sem token`() {
        mockMvc.get(RECURSO).andExpect { status { is4xxClientError() } }
    }

    @Test
    fun `deve retornar codigo 200 quando chamar usuarios com token`() {
        mockMvc.get(RECURSO){
    ...
    @Test
    fun `deve retornar codigo 200 quando chamar usuario por ir com token`() {
